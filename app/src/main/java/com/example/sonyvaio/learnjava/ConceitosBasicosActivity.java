...
public class ConceitosBasicosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        perguntas = questoesApplication.getPerguntaTipo("variaveis");
        Random random = new Random();
        pergunta = perguntas.get(random.nextInt(perguntas.size() - 1));

        escolha = new String[1];

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_conceitos);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Conceitos Básicos");
    ...
    public void onClick(View view) {
        if (escolha[0].equalsIgnoreCase(pergunta.getRespostaCorreta().getTexto())) {
            ...
            Intent intent = new Intent(ConceitosBasicosActivity.this, ConceitosBasicosActivity.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Sair", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            startActivity(new Intent(ConceitosBasicosActivity.this, MainActivity.class));
                            finish();
                        }
                    })
