...
public class OrientacaoObjetosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orientacao_objetos);

        questoesApplication = (QuestoesApplication) getApplicationContext();

        perguntas = questoesApplication.getPerguntaTipo("oo");
        Random random = new Random();
        pergunta = perguntas.get(random.nextInt(perguntas.size() - 1));

        escolha = new String[1];

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_oo);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Orientação a Objetos");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mtext = (TextView) findViewById(R.id.textTitle3);
        mtext.setText("" + pergunta.getTexto());

        mOpcao1 = (RadioButton) findViewById(R.id.opcao1);
        ...
        mOpcao2 = (RadioButton) findViewById(R.id.opcao2);
        ...
        mOpcao3 = (RadioButton) findViewById(R.id.opcao3);
        ...
        mOpcao4 = (RadioButton) findViewById(R.id.opcao4);
    ...
    public void onClick(View view) {
        if (escolha[0].equalsIgnoreCase(pergunta.getRespostaCorreta().getTexto())) {
            ...
            Intent intent = new Intent(OrientacaoObjetosActivity.this, OrientacaoObjetosActivity.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Sair", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            startActivity(new Intent(OrientacaoObjetosActivity.this, MainActivity.class));
                            finish();
                        }
                    })
